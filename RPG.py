...
#### #  || || || || || || || || || #####
"""
        self.texto1 = r"""Você está correndo da legião de um
deus chado Belzebu essa legião quer
o sacrificar para seu deus falso 
e pagão"""
        self.texto2 = r"""
Você se esconde em uma caverna que
por alí tinha os pagões o perderão 
em meio a correria"""
        self.fala_de_gabriel1= f"""
Tu vê o Arganjo Gabriel em tua frente
e diz: {jj.nome} não temas viz aqui
por ordens de Deus o real deus 
tu foi o escolido por Deus para derrotar
esses deuses falsos
"""
        self.fala_de_gabriel2 = r'''
