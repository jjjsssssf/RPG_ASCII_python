...
o Nome dele é Asmodeus """
        self.texto2 = f"""Adam: {jj.nome} vá na fortalesa de
Asmodeus e mate todos por lá e pegue
seu broche de imortalidade"""
        self.npc_1_vila = f"""
John: Olá viajante estamos com
um grande problama de demonios
ao redor da nossa vila você pode
nos ajudar
"""
...
def jogo():
    clear()
    linhas_jogo()
    ascii.exibir_texto_lento(ascii.texto1, atraso=0.2)
    linhas_jogo()
    input("=>")
    clear()
    linhas_jogo()
    ascii.exibir_texto_lento(ascii.texto2, atraso=0.2)
    linhas_jogo()
    input("=>")
    while jj.rodar_jogo:
        clear()
        ...
        if escolha == "Menu":
            ...
            while True:
                ...
                if esc == "Menu":
                    ...
                    linhas_jogo()
                    ascii.exibir_texto_lento(ascii.npc_1_vila, atraso=0.2)
                    linhas_jogo()
                elif esc == "Sair":
                    break
